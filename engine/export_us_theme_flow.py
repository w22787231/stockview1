...
THEME_SYMBOLS = {
    "AI晶片/GPU": """
        NVDA AMD AVGO MRVL ARM ALAB TSM ASML ASX GFS INTC QCOM
        MU MCHP MPWR SMCI DELL HPE VRT CLS COHR
    """,
    "HBM/記憶體/儲存": """
        MU WDC STX SNDK SIMO MRVL RMBS NVDA AMD AVGO
    """,
    "半導體設備-前段": """
    ...
    """,
    "加密礦機/區塊鏈": """
        COIN MSTR MARA RIOT CLSK HUT WULF IREN CIFR BTBT BITF HIVE
        CAN GLXY
    """,
    "金融科技/交易平台": """
        HOOD COIN SOFI AFRM UPST PYPL SQ FOUR NU IBKR SCHW CME ICE NDAQ
    """,
    "生技/醫療創新": """
